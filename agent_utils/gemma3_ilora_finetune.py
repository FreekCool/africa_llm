# agent_utils/gemma3_ilora_finetune.py
"""
ILoRA-enhanced fine-tuning for Gemma-3.
...
# Import Gemma3 model class
try:
    from transformers import Gemma3ForConditionalGeneration
except ImportError:
    # Fallback if Gemma3ForConditionalGeneration not available
    from transformers import AutoModelForCausalLM as Gemma3ForConditionalGeneration


def run_fine_tuned_gemma3_ilora(
    train_df,
    test_df,
    test_unseen_df,
    text_col,
    ...
    """
    Fine-tune Gemma-3 with ILoRA consistency regularisation.

    The evaluation structure is **identical** to ``run_fine_tuned_gemma3``:
    ...
    # ---------------- Model & tokenizer -----------------
    print(
        f"Starting ILoRA fine-tune of Gemma-3  "
    ...
    # dtype consistent with gemma3_finetune.py
    ...
    for learning_rate in learning_rates:
        ...
        for train_val_seed in train_val_seeds:
            ...
            # prepare for k-bit training (same as gemma3_finetune.py)
